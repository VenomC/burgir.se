...
<head>
 ...
 <meta charset="utf-8" />
 <title> Burgir - Gratis Plusmeny </title>
...
<!-- COUPON SECTION -->
 ...
 '>
  <div class='coupon-inner'>
   <!-- <center> -->
   <img id="newimage" src='https://dwfedcf5lscmq.cloudfront.net/prizeshop/60637b1178f39.jpg' width="100%" max-height/>

   <h3 id="h3">Gratis Friscoburgare vid köp av Friscomål</h3>
   <p id="desc" style='margin-left: 20px; margin-right: 20px;'> <b> Gäller vid köp av Friscomål (79-89 kr).  </b> </p>
   ...
   <p  style='font-size:11px; opacity: 0.9;'> <b>Kupongen är giltig t.o.m. <script src="/ExpirationDate.js"></script>.</b> </p>
  <br>
  <p id="bottomboi" style='font-size:11px; opacity: 0.9;'> Visa kupongen i kassan och få en Friscoburgare på köpet (59-66 kr) vid köp av ett Friscomål (79-89 kr). Erbjudandet kan ej kombineras med andra erbjudanden. </p>
...
<script type="text/javascript">
  ...
  document.getElementById("newimage").src = "https://dwfedcf5lscmq.cloudfront.net/prizeshop/60797760c70ac.jpg";
  document.getElementById("h3").innerHTML = "Gratis plusmeny";
  document.getElementById("desc").innerHTML = "Gäller vid köp av valfritt mål.";
  document.getElementById("bottomboi").innerHTML = "Visa kupongen i kassan och få en plusmeny (fr. 8 kr) på köpet vid köp av valfritt mål. Erbjudandet kan ej kombineras med andra erbjudanden.";
