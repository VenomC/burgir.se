...
<head> 
  ...
  <meta charset="utf-8" />  
  <title> Burgir - Gratis Burgir </title>
   ...
   <!-- COUPON SECTION -->
    ...
    '>
     <div class='coupon-inner'>
      <!-- <center> -->
      <img src='https://dwfedcf5lscmq.cloudfront.net/prizeshop/607701162116b.png' width="100%" max-height/>
   
      <h3>Gratis cheeseburgare</h3>
      <p style='margin-left: 20px; margin-right: 20px;'> <b> Gäller en cheeseburgare (fr. 18 kr).  </b> </p>
      ...
      <p style='font-size:11px; opacity: 0.9;'> <b>Kupongen är giltig t.o.m. <script src="/ExpirationDate.js"></script>.</b><br>Visa kupongen i kassan och få en cheeseburgare (fr. 16 kr). Erbjudandet kan ej kombineras med andra erbjudanden.</p>
